      ...
      *    pour ensuite afficher le calcul et son resultat.                   *
      *                                                                       *
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       01  WS-NUM-A            PIC 9(10).
       01  WS-NUM-B            PIC 9(10).
       01  WS-ADD-RESULT       PIC 9(11).
       01  WS-SUBTRACT-RESULT  PIC 9(11).
       01  WS-DIVIDE-RESULT    PIC 9(11).
       01  WS-MULTIPLY-RESULT  PIC 9(11).
       01  WS-TEMP             PIC 9(10).
